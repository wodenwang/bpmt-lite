...
INSERT INTO `CM_MENU` (`ID`, `SYS_FLAG`, `PARENT_ID`, `ACTION`, `DOMAIN_KEY`, `ICON`, `NAME`, `OPEN_TYPE`, `SORT`, `UPDATE_DATE`, `CREATE_DATE`, `PARAM_TYPE`, `PARAM_SCRIPT`, `PRI`) VALUES ('sys_thirdpart', '1', 'sys', '/thirdpart/ThirdpartAction/index.shtml', 'manage', 'link_edit.png', '外部第三方系统管理', '1', '13', '2014-11-05 23:18:52', '2013-06-09 00:16:07', '2', NULL, 'sys_thirdpart');
...
INSERT INTO `CM_PRI` (`PRI_KEY`, `CATELOG_TYPE`, `CATELOG_KEY`, `BUSI_NAME`, `DESCRIPTION`, `TYPE`, `CHECK_TYPE`, `CHECK_SCRIPT`) VALUES ('sys_thirdpart', '1', 'sys_thirdpart', '外部第三方系统管理', NULL, '1', '2', '${true}');
